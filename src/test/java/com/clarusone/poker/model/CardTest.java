...
public class CardTest {
    ...
    public void should_BuildCard_ForValidRankAndSuite() {
        Card.CardBuilder builder = new Card.CardBuilder(CardRank.ACE, CardSuite.DIAMONDS);
    ...
    public void should_Pass_ReflexiveEqualityTest_ForValidCards() {
        Card.CardBuilder builder = new Card.CardBuilder(CardRank.EIGHT, CardSuite.CLUBS);
        Card cludsEightCard1 = builder.build();

        builder = new Card.CardBuilder(CardRank.EIGHT, CardSuite.CLUBS);
    ...
    public void should_Fail_SymmetricEqualityTest_ForDifferentCards() {
        Card.CardBuilder builder = new Card.CardBuilder(CardRank.FIVE, CardSuite.DIAMONDS);
        Card cludsEightCard1 = builder.build();
